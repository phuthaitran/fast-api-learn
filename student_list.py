...
students = [
    {
        ...
        "mark": Mark(attendance=20, mid_term=17.5, final=15),
        "is_passed": True
    },
    {
        "student_id": 2,
        "student": Student(name="Long", dob=date(2005, 12, 1), group=Major.COMPUTER_SCIENCE),
        "mark": Mark(attendance=18, mid_term=10, final=10.5),
        "is_passed": False
    }
]
    ...
    for student in students:
        if all(
            (
                ...
                passed is None or student["is_passed"] == passed,
            )
        ):
...
def update_student(
    ...
    mark: Mark | None = None,
    is_passed: Annotated[bool | None, Body(...)] = None
):
    result = None
